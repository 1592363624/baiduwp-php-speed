...
<div class="col-lg-6 col-md-9 mx-auto mb-5 input-card page" id="index" style="display: none;">
    <div class="card">
        <div class="card-header bg-dark text-light">
            <text id="parsingtooltip" data-bs-toggle="tooltip" data-bs-placement="top" data-bs-html="true"
                data-bs-title="请稍等，正在连接服务器查询信息"><?php echo Language["IndexTitle"]; ?></text>
            <span style="float: right;" id="sviptooltip" data-bs-toggle="tooltip" data-bs-placement="top"
                data-bs-html="true" data-bs-title="请稍等，正在连接服务器查询SVIP账号状态"><span class="point point-lg"
                    id="svipstate-point"></span><span id="svipstate">Loading...</span></span>
        </div>
        <div class="card-body">
            ...
            <div class="form-group my-4" id="password" style="display: none;"><input type="text" class="form-control"
                    name="password" placeholder="请输入密码"></div>
            <div class="form-group mt-4 mb-3 d-grid">
                <button onclick="SubmitLink()" class="btn btn-primary"><?php echo Language["Submit"]; ?></button>
                <p class="text-center">关注公众号发送：密码【为保证稳定性和速度，可能会不定时更换】</p>
                <p class="text-center">进入顶部【频道】有最新官方百度云盘不限速下载教程</p>
                <p class="text-center">如果被限速了可以进上方QQ频道反馈</p>
                <p class="text-center">欢迎提供百度会员账号支持本站运行</p>
                ...
                <button type="button" class="btn btn-primary btn-block" data-toggle="modal"
                    data-target="#exampleModalCenter">赞助者名单列表：</button>
            </div>
        </div>
    </div>
    <script>
    ...
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <div class="modal-body">
                ...
                <p class="card-text">
                    <a class="btn btn-outline-primary" data-bs-toggle="modal" data-bs-target="#SendToAria2">发送到 Aira2 /
                        Motrix</a>
                    <a class="btn btn-outline-primary" href="" id="filecxx" style="display: none;">发送到 文件蜈蚣</a>
                </p>
                <p class="card-text"><a class="btn btn-outline-secondary" href="./#/help" target="_blank">下载帮助（必读）</a>
                </p>
            </div>
        ...
        <div class="modal-content">
            ...
            <div class="modal-footer">
                <button type="button" class="btn btn-primary" onclick="addUri()" data-bs-toggle="modal"
                    data-bs-target="#downloadpage">发送</button>
                <button type="button" class="btn btn-secondary" data-bs-toggle="modal"
                    data-bs-target="#downloadpage">返回</button>
            </div>
        </div>
    </div>
    <script>
    ...
    <div class="card-body">
        ...
        <div class="card-item">
            ...
            <div id="LanguageChoose">
                ...
                <span><?php echo Language["BrowserSettings"]; ?></span><span
                    id="Browser-Language"><?php echo BrowserLanguage; ?></span>
                <span><?php echo Language["CurrentDisplayed"]; ?></span><span
                    id="Displayed-Language"><?php echo Lang; ?></span>
            </div>
...
if (LanguageSetting === '') { // 判断用户设置的语言
    $('#Language-Select option[value=auto]').text('<?php echo Language["CurrentSetting"]; ?>' + $(
        '#Language-Select option[value=auto]').text());
    $('#Language-Select option[value=auto]')[0].selected = true;
} else if (LanguageSetting === 'zh-CN') { // zh-CN
    $('#Language-Select option[value="zh-CN"]').text('<?php echo Language["CurrentSetting"]; ?>' + $(
        '#Language-Select option[value="zh-CN"]').text());
    $('#Language-Select option[value="zh-CN"]')[0].selected = true;
} else if (LanguageSetting === 'en') { // en
    $('#Language-Select option[value="en"]').text('<?php echo Language["CurrentSetting"]; ?>' + $(
        '#Language-Select option[value="en"]').text());
...
$('#Language-Select').on('change', function() {
    const expires = (this.value === 'auto') ? 'Thu, 01 Jan 1970 00:00:00 GMT' : new Date(Date.now() +
        31536000000);
