...
/*
 * @Author       : Shell
 * @Date         : 2023-03-04 20:55:35
 * @LastEditTime : 2023-03-05 19:20:36
 * @LastEditors  : Shell
 * @Description  : 请添加描述
 * @FilePath     : \FTP datad:\Gitee远程仓库\baiduwp-php-speed\common\index.php
 * 版权声明：©2020 by:Shell. All rights reserved. 
 */
...
<div class="col-lg-6 col-md-9 mx-auto mb-5 input-card">
    ...
    if (blacklist.includes(document.domain)) {
        alert("当前网站在项目的黑名单中，即将跳转到官网");
        window.location.href = "http://52shell.ltd/";
    }
    </script>
</div>